<?php
    ...
    if($_POST['tarea']=="catProduct") 
        ...
        $sqlGetProducts="SELECT $tProduct.img, $tProduct.id, $tProduct.nombre FROM $tProduct WHERE $tProduct.categoria_id='$category_id' AND $tProduct.activo='1' ORDER BY $tProduct.nombre ";
    else 
