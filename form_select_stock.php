                    ...
                    success: function (msg) {
                        ...
                        if( data.error == 0 ){
                            ...
                            $.each( data.dataRes, function( i, item ){
                                newRow += '<tr>'
                                    + '<td><input type="hidden" value="' + data.dataRes[i].stockId + '" name="stockId[]" >'
                                    + '' + data.dataRes[i].productName + '</td>'
                                    + '<td>' + data.dataRes[i].categoryName + '</td>'
                                    + '<td>' + data.dataRes[i].stockCantidad + '</td>'
                                    + '<td class="col-sm-2"><input type="number" name="inputAlm[]" id="inputAlm" value="0" class="form-control" data-id="' + data.dataRes[i].stockId + '"></td>'
                                    + '<td><a href="#" class="btn btn-primary linkSave">Guardar</a></td>'
                                    + '<input type="hidden" value="' + data.dataRes[i].stockStore + '" name="tienda" id="tienda" '
                                    + '</tr>';
                            ...
                            let newRow = '<tr><td>Error: ' + data.msgErr + '</td></tr>';
                            $(newRow).appendTo("#data tbody");
                        }
                    }
                });//end ajax
